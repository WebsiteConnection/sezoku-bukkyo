...
export const SITE_CONTENT: SiteContent = {
  ...
  sites: [
    ...
    },
    {
      ...
      summary: "Extensive research and video analysis of Buddhist texts from a secular, historical, and academic perspective. Some of Doug's videos are for beginners, while others explain the traditional teachings, as well.",
      image: "/doug.png",
      links: [
    ...
    {
      name: "4. Noah Rasheta",
      summary: "Host of the Secular Buddhism Podcast, and developer of an array of Buddhist information resources accessible through AI-powered chat.",
      image: "/noah.png",
      links: [
    ...
    },
    {
      ...
      summary: "Reinterprets the Lotus Sūtra's climactic revelation of an Eternal Buddha as a universal ethic sourced in immanence, and introduces various options for a corresponding secular practice.",
      image: "/lotus.png",
      links: [
